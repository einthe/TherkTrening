...
export const componentDefinitions = [
  ...
  },
  {
    ...
    kind: "logger",
    description: "Keep track of every rep, set, and weight.",
    icon: "dumbbell",
  ...
  },
  {
    ...
    kind: "logger",
    description: "Volleyball, a run, or whatever gets you moving.",
    icon: "activity",
  ...
  },
  {
    ...
    name: "Statistic",
    kind: "display",
    description: "One useful number from your recorded data.",
    icon: "gauge",
    supportedEventTypes: ["exercise", "pain_measurement", "measurement"],
    capabilities: { canReadEvents: true, canRunOperators: true },
    config: {
  ...
  },
  {
    ...
    kind: "display",
    description: "Your latest check-ins and training, in one place.",
    icon: "history",
    supportedEventTypes: [],
