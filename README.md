...
Apply `202609240008_analysis_components.sql` before deploying the Analysis section. Existing component visibility is preserved and Analysis starts empty. Component settings now let you select Dashboard, Analysis, both, or neither; the same component and logged data are shared across pages.
...
- **Analysis** is a second workspace page for your selected components. In any component’s Settings, choose **Dashboard** and/or **Analysis** under **Show component in**. Clear both to hide it while keeping it available in Components. Titles, configuration, and component order are shared across pages.
- Component management lives on **Components**: use **Add component** to add cards and **Customize** to reorder or remove them. The optional **Last 7 days** component shows sessions, pain check-ins, and active days; its Settings control Dashboard and Analysis visibility.
